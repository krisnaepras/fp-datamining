...
- **P1** = Pembicara 1 → Bagian 1–3  
- **P2** = Pembicara 2 → Bagian 4–6  
- **P3** = Pembicara 3 → Bagian 7–11  
...
**P1:**  
“Notebook ini mengikuti alur **CRISP-DM**: mulai dari *business understanding*, *data understanding*, *data preparation*, *modeling*, *evaluation*, sampai *deployment*.  
...
**P2 (Cell 14 – copy untuk patterned dataset):**  
...
**P2 (Cell 14–16 – perhitungan fitur):**  
...
- Hari **crash**: harga penutupan sangat dekat dengan *low* harian → PLR sangat besar, PTR kecil.  
- Hari **moon**: harga penutupan sangat dekat dengan *high* harian → PTR besar.  
...
**P3 (Cell 26–28 – deteksi Diamond Crash):**  
...
**P3 (contoh isi doge_diamond_crash_events.csv):**  
